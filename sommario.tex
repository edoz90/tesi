...
Il quinto raccoglierà le varie tipologie di attacco possibili su blockchain. Da notare è che non verranno trattate vulnerabilità su applicativi relativi all'utilizzo della blockchain per le criptomoente come \textit{wallet}, \textit{exchange} o software per il \texit{mining}.
