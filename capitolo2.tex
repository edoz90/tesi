...
\end{equation}
Una volta raggiunto $n$ per cui il \textit{reward} per il mining sarà minore di un Satoshi, il totale della somma \ref{eq:maxbtc} compone il totale di Bitcoin disponibili: $20999999.9769$ (arrotondato per la rappresentazione a virgola mobile).
