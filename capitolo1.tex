...
\textit{ECDSA} è un algoritmo progettato partendo da \textit{DSA}, uno standard del governo statunitense, combinato con \textit{crittografia ellitica} la quale permette di avere lo stesso grado di sicurezza dei sistemi tradizioni (RSA, DSA, DH) ma con chiavi di dimensione inferiore.\newline
\begin{table}[H]
    \centering
